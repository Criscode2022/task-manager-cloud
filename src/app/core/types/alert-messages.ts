export enum AlertMessages {
  ...
  InstallAlert = 'You can install this PWA on your device by adding it to your home screen from the browser settings',
  GoOfflineAlert = 'Are you sure that you want to go offline? You will need your personal PIN to sync your tasks again',
}
